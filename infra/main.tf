...
module "ec2" {
  ...
  subnet_id                     = tolist(module.networking.infraCar_public_subnets)[0]
...
module "lb_target_group" {
  ...
  lb_target_group_name     = "infraCar-lb-target-group"
...
module "rds_db_instance" {
  ...
  mysql_dbname         = "infraCarDB" # Change, use secret manager
}
